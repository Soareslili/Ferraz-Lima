      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className="text-slate-700 leading-relaxed mt-8">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-9 w-9 cursor-pointer border-2 border-gray-700 rounded-full bg-blue-200 flex items-center justify-center group/button"
            >
